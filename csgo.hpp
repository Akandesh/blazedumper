...
constexpr ::std::int64_t timestamp = 15922579462428358
namespace netvars {
...
constexpr ::std::ptrdiff_t dwSensitivity = 0xD509EC;
constexpr ::std::ptrdiff_t dwSensitivityPtr = 0xD509C0;
...
constexpr ::std::ptrdiff_t find_hud_element = 0x62A01B30;
